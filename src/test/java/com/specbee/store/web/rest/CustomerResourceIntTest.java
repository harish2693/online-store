...
import com.specbee.store.domain.Customer;
import com.specbee.store.domain.User;
import com.specbee.store.repository.CustomerRepository;
import com.specbee.store.service.CustomerService;
...
import com.specbee.store.domain.enumeration.Gender;
/**
...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_EMAIL = "(L@i\\.l";
    private static final String UPDATED_EMAIL = "Ce@:y.5";
    ...
    @Test
    @Transactional
    public void checkAddressLine2IsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
