package com.specbee.store.repository;

import com.specbee.store.StoreApp;
import com.specbee.store.config.Constants;
import com.specbee.store.config.audit.AuditEventConverter;
import com.specbee.store.domain.PersistentAuditEvent;
...
import static com.specbee.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
