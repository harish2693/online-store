package com.specbee.store.domain;
...
public class OrderItem implements Serializable {
    ...
    @NotNull
    @DecimalMin(value = "0")
    @Column(name = "toatal_price", precision = 10, scale = 2, nullable = false)
    ...
    public BigDecimal getToatalPrice() {
        return toatalPrice;
    }

    public OrderItem toatalPrice(BigDecimal toatalPrice) {
        this.toatalPrice = toatalPrice;
        return this;
    }

    public void setToatalPrice(BigDecimal toatalPrice) {
        this.toatalPrice = toatalPrice;
    }
